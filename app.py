...
def recommend_song(mood):
    ...
    mood_songs = {
        '신남': [
            ...
            # {"title": "Super Shy", "artist": "NewJeans", "youtube_link": "https://youtu.be/k8yvl4911g8?si=lTskrX9B2Gz36x5K"} # 뉴진스 곡 삭제 완료!
        ],
        '잔잔한': [
            ...
            # {"title": "어떻게 이별까지 사랑하겠어, 널 사랑하는 거지", "artist": "악동뮤지션", "youtube_link": "https://youtu.be/mZz9uYdj_v4?si=Rvt35G7_uhvNBeQm"} # 악뮤 곡 삭제 완료!
        ],
        '위로': [
            ...
            # {"title": "별을 세는 밤", "artist": "스탠딩 에그", "youtube_link": "https://youtu.be/y9_Yq-N-Nn0?si=p837p1vC_-q_vT0K"} # 스탠딩 에그 곡 삭제 완료!
        ],
        '사랑': [
            ...
            # {"title": "선물", "artist": "멜로망스", "youtube_link": "https://youtu.be/I9j4N6o16A8?si=fL5H-P4Kk6Qe0fFf"} # 멜로망스 곡 삭제 완료!
        ],
        '청춘': [
            ...
            {"title": "Lucky Charm", "artist": "보이넥스트도어", "youtube_link": "https://youtu.be/deC7LUb6ls4?si=FjKqrtUIp-MW3NKpY"}
        ]
    }
...
# 유저가 분위기를 선택했을 때만 노래 추천 보여주기 (기존과 동일)
